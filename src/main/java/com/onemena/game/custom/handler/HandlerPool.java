...
import com.onemena.game.utils.HandlerUtil;
			...
			executorService.execute(new Runnable() {
				...
				private void handler() {
					...
					if (handlerDataModal != null) {
						...
						HandlerUtil.getHandlerInstance(messageLite.getClass().getSimpleName()).handler(messageLite, handlerDataModal.getCtx());
					}
				}
